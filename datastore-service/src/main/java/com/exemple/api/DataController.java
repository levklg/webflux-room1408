...
import com.exemple.domain.MessageDto;
import com.exemple.service.DataStore;
...
public class DataController {
    ...
    @PostMapping(value = "/msg/all")
    public Mono<Void> messageToAllRooms(@RequestBody MessageDto messageDto) {
        return Mono.error(new ChatException("Sending messages to room 1408 is not allowed"));
    }

    @GetMapping(value = "/msg/all", produces = MediaType.APPLICATION_NDJSON_VALUE)
    public Flux<MessageDto> getAllMessagesFromAllRooms() {
